...
.graphiql-container .tab:hover {
  background-image: linear-gradient(rgba(245, 245, 245, 0.7), rgb(215, 215, 215));
  color: rgba(0, 0, 0, 0.8);
}
.graphiql-container .tab.active {
  background-image: linear-gradient(rgba(233, 233, 233, 0.7), rgb(205, 205, 205));
  color: black;
}
/* {
...
/*# sourceMappingURL=vendors-node_modules_expose-loader_dist_runtime_getGlobalThis_js-node_modules_graphiql_esm_in-b41003.css.map*/